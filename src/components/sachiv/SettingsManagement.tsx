...
export function SettingsManagement({ panchayatId }: SettingsManagementProps) {
  ...
  const handleSaveHero = async (e?: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const updated = await settingsAPI.updateHero(panchayatId, settings.hero);
      setSettings(updated);
  ...
  const handleSaveAbout = async (e?: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const updated = await settingsAPI.updateAbout(panchayatId, settings.about);
      setSettings(updated);
  ...
  const handleSaveContact = async (e?: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      const updated = await settingsAPI.updateContact(panchayatId, settings.contact);
      setSettings(updated);
  ...
  const handleLogoUpload = async (file: File) => {
    ...
    setSaving(true);
    try {
      const updated = await settingsAPI.uploadLogo(panchayatId, file);
      setSettings(updated);
  ...
  const handleHeroImageUpload = async (file: File) => {
    ...
    setSaving(true);
    try {
      const updated = await settingsAPI.uploadHeroImage(panchayatId, file);
      setSettings(updated);
